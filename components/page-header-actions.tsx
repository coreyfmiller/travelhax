...
import { ChevronDown, ChevronUp, Check, Clipboard, Loader2, Mail, Plus, Trash2, Settings2, FileText } from "lucide-react"

// Sample Email Data for the Manual Input tab
const sampleEmails = {
        ...
        <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
            <div className="bg-primary/5 p-4 border-b border-border flex items-center justify-between">
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-3 pr-6 border-r border-primary/20">
                        ...
                        <h3 className="font-extrabold text-xl tracking-tight hidden sm:block">Trip Engine</h3>
                    </div>
            ...
            {!isCollapsed && (
                <div className="animate-in fade-in slide-in-from-top-1 duration-200">
                    <Tabs value={activeTab}>
                        <TabsContent value="setup" className="m-0 border-0 p-0">
                                        ...
                                        <div className="rounded-lg bg-background border border-primary/20 p-5 shadow-sm flex flex-col justify-between flex-1">
                                            <div>
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    />
                                                    <Button onClick={handleAddSender} disabled={addingSender} className="h-10 px-4 gap-2 font-bold shadow-sm shrink-0">
                                                        {addingSender ? <Loader2 size={16} className="animate-spin" /> : <Plus size={16} />}
                                                        Add
                                                    </Button>
                                                </div>
                                            </div>
