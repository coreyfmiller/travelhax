...
import { ChevronDown, ChevronUp, Check, Clipboard, Loader2, Mail, Plus, Trash2 } from "lucide-react"
...
export function ApprovedSenders() {
    ...
    return (
        <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
            ...
            {!isCollapsed && (
                <div className="bg-primary/5 p-5 border-b border-border transition-all animate-in fade-in slide-in-from-top-1 duration-200">
